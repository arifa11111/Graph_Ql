  ...
  return (
    <ThemeProvider theme={theme}>
      <Autocomplete
        ...
        onBlur={(e) => {
          if((e.target as HTMLInputElement).value === "" && e.currentTarget.firstChild?.firstChild?.nodeName === "INPUT"){
        ...
        renderTags={(tagValue, getTagProps) => {
          return tagValue.map((option, index) => (
            <Chips {...getTagProps({ index })} label={option.area} data-testid="chip-check"/>
          ));
        }}
