...
const {location} = props
  return (
    ...
    <Box data-testid="header" className="mainBox" sx={{display:"flex",
       ...
       <Box style={{display:"flex",justifyContent:"space-between",width:"678px"}}>
            ...
            <Box className='searchBarBox' style={{border:"solid 1px",
                ...
                <Typography variant="body1" sx={{height:"22px",marginLeft:"30px",color:theme.palette.light?.four,
                    transform: 'translate(14px, 3px)'}}>{location }
                </Typography>
